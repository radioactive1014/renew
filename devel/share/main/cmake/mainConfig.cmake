...
if("TRUE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/rokon/renew/src/main)
  set(main_DEVEL_PREFIX /home/rokon/renew/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/rokon/renew/install)
...
if(NOT "/home/rokon/renew/src/main/include" STREQUAL "")
  set(main_INCLUDE_DIRS "")
  set(_include_dirs "/home/rokon/renew/src/main/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rokon/renew/src/main/${idir}'.  Ask the maintainer 'Your Name <you@example.com>' to fix it.")
    endif()
