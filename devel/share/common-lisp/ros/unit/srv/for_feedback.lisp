...
(cl:defmethod angle-val ((m <for_feedback-request>))
...
(cl:ensure-generic-function 'angle_second-val :lambda-list '(m))
(cl:defmethod angle_second-val ((m <for_feedback-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unit-srv:angle_second-val is deprecated.  Use unit-srv:angle_second instead.")
  (angle_second m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <for_feedback-request>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'angle))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'angle_second))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <for_feedback-request>) istream)
  "Deserializes a message object of type '<for_feedback-request>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'angle_second) (roslisp-utils:decode-single-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<for_feedback-request>)))
  ...
  "7d458cb8533f4c32b4ea6ff53f72ef23")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'for_feedback-request)))
  "Returns md5sum for a message object of type 'for_feedback-request"
  "7d458cb8533f4c32b4ea6ff53f72ef23")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<for_feedback-request>)))
  ...
  (cl:format cl:nil "~%~%float32 positionx~%float32 positiony~%~%float32 angle~%float32 angle_second~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'for_feedback-request)))
  "Returns full string definition for message of type 'for_feedback-request"
  (cl:format cl:nil "~%~%float32 positionx~%float32 positiony~%~%float32 angle~%float32 angle_second~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <for_feedback-request>))
  ...
  (cl:list 'for_feedback-request
    ...
    (cl:cons ':angle_second (angle_second msg))
))
