...
if("TRUE" STREQUAL "TRUE")
  set(unit_SOURCE_PREFIX /home/rokon/renew/src/unit)
  set(unit_DEVEL_PREFIX /home/rokon/renew/devel)
  set(unit_INSTALL_PREFIX "")
  set(unit_PREFIX ${unit_DEVEL_PREFIX})
else()
  set(unit_SOURCE_PREFIX "")
  set(unit_DEVEL_PREFIX "")
  set(unit_INSTALL_PREFIX /home/rokon/renew/install)
...
if(NOT "/home/rokon/renew/devel/include" STREQUAL "")
  set(unit_INCLUDE_DIRS "")
  set(_include_dirs "/home/rokon/renew/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'unit' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rokon/renew/src/unit/${idir}'.  Ask the maintainer 'Your Name <you@example.com>' to fix it.")
    endif()
